...
- El botón "Agregar al carrito" en la página de producto está deshabilitado a propósito (placeholder): el carrito todavía no existe. La selección de talla interactiva y el flujo de agregar al carrito quedan para un ticket posterior — mostrar tallas como lista de solo lectura (`Badge` por talla, "(agotado)" si stock es 0) es el alcance correcto de #17.
